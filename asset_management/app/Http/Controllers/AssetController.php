...
class AssetController extends Controller
{
    ...
    {
        $assets = Asset::with('entity:id,ent_name', 'brand:id', 'modelo:id,name', 'category:id,name', 'units:id,unit_contact,unit_address,name', 'suppliers:id,name,email,phone,address')
            ->orderBy('id', 'desc')
            ->paginate(20);
    ...
    public function indexAll()
    {
        ...
        $assets = $assets = Asset::with('entity:id,ent_name', 'brand:id', 'modelo:id,name', 'category:id,name', 'units:id,unit_contact,unit_address,name', 'suppliers:id,name,email,phone,address')
